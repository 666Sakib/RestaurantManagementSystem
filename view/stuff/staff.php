...
<head>
  ...
  <link rel="stylesheet" href="reeee.css">
...
<div class="topnav">
  ...
  <a href='Details.html'style ="color:#;">Details</a>
  <a href='about.php'style ="color:#;">About</a>
  <a href='logout.php'style ="float:right""color:#;">LogOut</a>
  
</div>


<h2>Here The Staff Names:</h2>
<p></p>
<br>
...
<div class="row">
  <div class="column">
    <div class="card">
      <img src="pic/111.jpg" alt="RAZ" style="width:100%">
      <div class="container">
        <h2>RAZ KHAN</h2>
        <p class="title">#Staff1</p>
        <p>Hi!! I am Raz.i am from dhaka.My hobby is playing cricket.I want to be a good business man.</p>
        <p>razstaff1@gmail.com</p>
        <p><button class="button">phn:+8801712345482</button></p>
      </div>
    </div>
  </div>
  ...
  <div class="column">
    <div class="card">
      <img src="pic/333.jpg" alt="ARMAN" style="width:100%">
      <div class="container">
        <h2>ARMAN HASAN</h2>
        <p class="title">#Staff2</p>
        <p>Hi!!I am Arman.i am from chittagong.My hobby is playing reading different kinds of book.I want to be a good writer.</p>
        <p>armanstaff2@gmail.com</p>
        <p><button class="button">phn:+8801723145689</button></p>
      </div>
    </div>
  </div>
  ...
  <div class="column">
    <div class="card">
      <img src="pic/2222.jpg" alt="LIPA" style="width:100%">
      <div class="container">
        <h2>LIPA AHSAN</h2>
        <p class="title">#Staff3</p>
        <p>Hi!! I am Lipa.i am from dhaka.My hobby is singing song.I want to be a good human.</p>
        <p>lipastaff3@gmail.com</p>
        <p><button class="button">phn:+8801725326598</button></p>
      </div>
    </div>
  </div>
</div>
...
<h3>lets satisfy our hunger with our tasty dishes:</h3>
